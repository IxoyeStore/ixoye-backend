...
export interface ApiDeviceTokenDeviceToken extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    platform: Schema.Attribute.Enumeration<['android']> &
...
export interface ApiFilterFilter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['select', 'checkbox', 'range']> &
      Schema.Attribute.Required;
...
export interface ApiImporterImporter extends Struct.CollectionTypeSchema {
  collectionName: 'importers';
  info: {
    displayName: 'Importer';
    pluralName: 'importers';
    singularName: 'importer';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subDepartment: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    motherLastName: Schema.Attribute.String;
    phone: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['b2c', 'b2b']> &
      Schema.Attribute.Required &
...
export interface PluginUsersPermissionsUser
  ...
  info: {
    description: 'Default User model extended';
    displayName: 'User';
    pluralName: 'users';
    singularName: 'user';
  };
